...
export function Presentation() {
  ...
  const profile = {
    name: 'Yash Kiritkumar Parmar',
    age: '22 years old',
    location: 'Ahmedabad, India',
    description:
      "Hey 👋\nI'm Yash, an AI/ML software engineer passionate about building agentic AI systems, LLM-powered applications, and intelligent automation workflows.",
    ...
    <div className="mx-auto w-full max-w-5xl py-6 font-sans">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col space-y">
          ...
          >
            {['AI/ML', 'Developer', 'Data Science', 'LLM Engineer'].map(
              (tag) => (
                <span
                  key={tag}
