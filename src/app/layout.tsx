...
export const metadata: Metadata = {
  ...
  description: "Interactive AI-powered portfolio of Yash Parmar — AI/ML Software Engineer specializing in LLM applications, agentic AI, and workflow automation",
  keywords: [
    "Yash Parmar",
    "Portfolio",
    "AI/ML Engineer",
